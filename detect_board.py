...
def detect_chess_board(screen):
    ...
    chessboard_contours = [cnt for cnt in contours if cv2.contourArea(cnt) > 500]
    ...
    if chessboard_contours:
        ...
        # Corners is a multi dimensional array of shape (N, 2), perform additional checks for lower latency
        top_left = corners[0]
